                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                {{ Form::select('type', $types, null, array('class' => 'form-control vehicle-type')) }}
                                <span class="input-group-btn">
                        ...
                        <div class="form-group">
                            ...
                            {{ Form::text('seats_number', null, array('class' => 'form-control seats-number')) }}
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            {{ Form::text('chassis_number', null, array('class' => 'form-control chassis-number')) }}
                        </div>
                        <div class="form-group">
                            <label>{{ trans('main.fuel_type') }} *</label>
                            {{ Form::select('fuel_type', $fuel_types, null, array('class' => 'form-control fuel-type')) }}
                        </div>
                        <div class="form-group">
                ...
                <div class="row m-t">
                    <div class="col-sm-12">
                        <div class="text-center">
                            ...
                            <button type="button" class="btn btn-primary m-t-n-xs insert-vehicle"><strong>{{ trans('main.save') }}</strong></button>
                        </div>
                    </div>
                </div>
                {{ Form::close() }}
