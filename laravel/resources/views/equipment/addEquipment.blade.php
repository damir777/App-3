...
@section('content')
    <div class="row border-bottom white-bg dashboard-header">
        <div class="col-sm-12">
            <h2>{{ trans('main.new_equipment') }}</h2>
        </div>
    </div>
    <div class="row border-bottom white-bg dashboard-header">
        <div class="col-lg-12">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                {{ Form::select('type', $types, null, array('class' => 'form-control equipment-type')) }}
                                <span class="input-group-btn">
                ...
                <div class="row m-t">
                    <div class="col-sm-12">
                        <div class="text-center">
                            ...
                            <button type="button" class="btn btn-primary m-t-n-xs insert-equipment"><strong>{{ trans('main.save') }}</strong></button>
                        </div>
                    </div>
                </div>
                {{ Form::close() }}
