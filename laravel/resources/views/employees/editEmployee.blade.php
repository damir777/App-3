...
@section('content')
    <div class="row border-bottom white-bg dashboard-header">
        <div class="col-sm-12">
            <h2>{{ trans('main.edit_employee') }}</h2>
        </div>
    </div>
    <div class="row border-bottom white-bg dashboard-header">
        <div class="col-lg-12">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('code', $employee->code, array('class' => 'form-control code')) }}
                                        </div>
                                        <div class="form-group">
                                            <label>{{ trans('main.employee_name') }} *</label>
                                            {{ Form::text('name', $employee->name, array('class' => 'form-control name')) }}
                                        </div>
                                        <div class="form-group">
                                            <label>{{ trans('main.work_type') }} *</label>
                                            <div class="input-group">
                                                {{ Form::select('work_type', $work_types, $employee->work_type_id, array('class' => 'form-control work-type')) }}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                {{ Form::select('contract_type', $contract_types, $employee->contract_type_id, array('class' => 'form-control contract-type')) }}
                                                <span class="input-group-btn">
                                        ...
                                        <div class="form-group">
                                            ...
                                            {{ Form::select('sex', array('M' => 'M', 'Ž' => 'Ž'), $employee->sex, array('class' => 'form-control sex')) }}
                                        </div>
                                        <div class="form-group">
                                            <label>{{ trans('main.contract_start_date') }} *</label>
                                            <div class="input-group date">
                                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                {{ Form::text('contract_start_date', $employee->contract_start_date, array('class' => 'form-control contract-start-date')) }}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date">
                                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                {{ Form::text('contract_expire_date', $employee->contract_expire_date, array('class' => 'form-control contract-expire-date')) }}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date">
                                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                {{ Form::text('medical_certificate_expire_date', $employee->medical_certificate_expire_date, array('class' => 'form-control medical-certificate-expire-date')) }}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date">
                                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                {{ Form::text('contract_end_date', $employee->contract_end_date, array('class' => 'form-control contract-end-date')) }}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('oib', $employee->oib, array('class' => 'form-control oib')) }}
                                        </div>
                                        <div class="form-group">
                                            <label>{{ trans('main.birth_date') }} *</label>
                                            <div class="input-group date">
                                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                                {{ Form::text('birth_date', $employee->birth_date, array('class' => 'form-control birth-date')) }}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label>{{ trans('main.citizenship') }} *</label>
                                            {{ Form::select('citizenship', $countries, $employee->citizenship_id, array('class' => 'form-control citizenship')) }}
                                        </div>
                                        <div class="form-group">
                                            <label>{{ trans('main.birth_city') }} *</label>
                                            {{ Form::text('birth_city', $employee->birth_city, array('class' => 'form-control birth-city')) }}
                                        </div>
                                        <div class="form-group">
                                            <label>{{ trans('main.country') }} *</label>
                                            {{ Form::select('country', $countries, $employee->country_id, array('class' => 'form-control country')) }}
                                        </div>
                                        <div class="form-group" id="city-id-div">
                                            <label>{{ trans('main.city') }} *</label>
                                            {{ Form::select('city_id', $cities, $employee->city_id, array('class' => 'form-control city-id')) }}
                                        </div>
                                        <div class="form-group" id="city-div" style="display: none">
                                            <label>{{ trans('main.city') }} *</label>
                                            {{ Form::text('city', $employee->city, array('class' => 'form-control city')) }}
                                        </div>
                                        <div class="form-group">
                                            <label>{{ trans('main.address') }} *</label>
                                            {{ Form::text('address', $employee->address, array('class' => 'form-control address')) }}
                                        </div>
                                        <div class="form-group">
                                            <label>{{ trans('main.phone') }} *</label>
                                            {{ Form::text('phone', $employee->phone, array('class' => 'form-control phone')) }}
                                        </div>
                                        <div class="form-group">
                                            <label>{{ trans('main.status') }} *</label>
                                            {{ Form::select('status', $statuses, $employee->status_id, array('class' => 'form-control status')) }}
                                        </div>
                                        <div class="asset-image">
                                            {{ HTML::image($employee->picture, '', array('class' => 'img img-responsive')) }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            {{ Form::select('user_role', $roles, $employee->role_id, array('class' => 'form-control user-role')) }}
                                        </div>
                                        <div class="form-group">
                                            <label>{{ trans('main.email') }}</label>
                                            {{ Form::text('email', $employee->email, array('class' => 'form-control email')) }}
                                        </div>
                                        <div class="form-group">
                    ...
                    <div class="row m-t-xl">
                        <div class="col-sm-12">
                            <div class="text-center">
                                ...
                                <button type="button" class="btn btn-primary m-t-n-xs update-employee"><strong>{{ trans('main.save') }}</strong></button>
                            </div>
                        </div>
                    </div>
                    {{ Form::close() }}
    ...
    <script>
        ...
        var has_account = '{{ $employee->has_account }}';
