...
function validateForm(is_insert)
{
    ...
    var inputs_array = [/*'code', */'manufacturer', 'name', 'model', 'picture', 'manufacture-year', 'serial-number', 'mass',
        'tool-type', 'internal-code', 'purchase-date', 'sale-date'];
    ...
    $.each(inputs_array, function(index, value) {
        ...
        if (value == 'manufacturer' || value == 'tool-type')
        {
        ...
        else if (value == 'purchase-date' || value == 'sale-date')
        {
            if (value == 'sale-date')
            {
...
{
    $.ajax({
        url: ajax_url + 'resources/tools/insert',
        type: 'post',
        dataType: 'json',
        contentType: false,
        processData: false,
        ...
        success: function(data) {
            ...
            {
                case 1:
                    location.href = ajax_url + 'resources/tools/list';
                    break;
                case 2:
...
{
    $.ajax({
        url: ajax_url + 'resources/tools/update',
        type: 'post',
        dataType: 'json',
        contentType: false,
        processData: false,
