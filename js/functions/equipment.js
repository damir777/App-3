...
function validateForm(is_insert)
{
    ...
    var inputs_array = ['code', 'manufacturer', 'name', 'model', 'picture', 'manufacture-year', 'serial-number', 'mass',
        'equipment-type', 'purchase-date', 'sale-date'];
    ...
    $.each(inputs_array, function(index, value) {
        ...
        if (value == 'manufacturer' || value == 'equipment-type')
        {
...
{
    $.ajax({
        url: ajax_url + 'resources/equipment/insert',
        type: 'post',
        dataType: 'json',
        contentType: false,
        processData: false,
        ...
        data: new FormData($('.equipment-form')[0]),
        success: function(data) {
            ...
            {
                case 1:
                    location.href = ajax_url + 'resources/equipment/list';
                    break;
                case 2:
...
{
    $.ajax({
        url: ajax_url + 'resources/equipment/update',
        type: 'post',
        dataType: 'json',
        contentType: false,
        processData: false,
...
$(document).ready(function() {
    ...
    $('.insert-equipment').on('click', function() {
